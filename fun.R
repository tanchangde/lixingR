...
get_cn_company_senior_executive_shares_change <- function(token = NULL, start_date = NULL, end_date = NULL, stock_code = NULL) {
  url <- "https://open.lixinger.com/api/cn/company/senior-executive-shares-change"
  api_type <- url %>%
    stringr::str_match(., "company.*$") %>%
    stringr::str_replace_all(., "/", "_")
  create_post(
...
get_cn_company_shareholders_num <- function(token = NULL, start_date = NULL,
                                            end_date = NULL, stock_code = NULL) {
  url <- "https://open.lixinger.com/api/cn/company/shareholders-num"
  api_type <- url %>%
    stringr::str_match(., "company.*$") %>%
    stringr::str_replace_all(., "/", "_")
  create_post(
...
get_cn_company_block_deal <- function(token = NULL, start_date = NULL,
                                  end_date = NULL, stock_code = NULL) {
  url <- "https://open.lixinger.com/api/cn/company/block-deal"
  api_type <- url %>%
    stringr::str_match(., "company.*$") %>%
    stringr::str_replace_all(., "/", "_")
  create_post(
